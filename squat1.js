...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    if (leftKneeAngle < 65) {
      ...
      canvasCtx.fillText('Push Up', leftKneePos.x, leftKneePos.y - 10);
    }
    if (leftKneeAngle > 140) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Push Down', leftKneePos.x, leftKneePos.y - 10);
    }
    if (rightKneeAngle < 65) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Push Up', rightKneePos.x, rightKneePos.y - 10);
    }
    if (rightKneeAngle > 140) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Push Down', rightKneePos.x, rightKneePos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
