...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    if (leftKneeAngle < 65) {
      ...
      canvasCtx.fillText('Push', leftKneePos.x, leftKneePos.y - 10);
    }
    if (leftKneeAngle > 135) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Pull', leftKneePos.x, leftKneePos.y - 10);
    }
    if (rightKneeAngle < 65) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Push', rightKneePos.x, rightKneePos.y - 10);
    }
    if (rightKneeAngle > 135) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Pull', rightKneePos.x, rightKneePos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
